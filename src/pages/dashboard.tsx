...
import { useRoqPlatformUserProfiles, usePerformanceReviewCount, useJobCount, useJobApplicationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const performanceReviewStat = usePerformanceReviewCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: performanceReviewStat?.data,
